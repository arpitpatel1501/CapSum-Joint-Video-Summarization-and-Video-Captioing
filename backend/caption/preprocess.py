...
def build_vocab(word_count_thresh):
    ...
    sents_train = open('./caption/text_files/sents_train_lc_nopunc.txt','r').read().splitlines()
    sents_val = open('./caption/text_files/sents_val_lc_nopunc.txt','r').read().splitlines()
    sents_test = open('./caption/text_files/sents_test_lc_nopunc.txt','r').read().splitlines()
    unk_required = False
    all_captions = []
    word_counts = {}
